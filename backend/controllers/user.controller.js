...
export const register = async (req, res) => {
    try {
        ...
        const profilePhoto = `https://api.imgbb.com/1/upload`;
...
export const login = async (req, res) => {
    try {
        ...
        return res.status(200).cookie("token", token, { maxAge: 1 * 24 * 60 * 1000, httpOnly: true, sameSite: "lax" ,secure:false }).json({
